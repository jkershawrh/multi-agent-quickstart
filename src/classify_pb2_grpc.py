...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in classify_pb2_grpc.py depends on'
...
class ClassifyStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Classify = channel.unary_unary(
                ...
                response_deserializer=classify__pb2.ClassifyResponse.FromString,
...
def add_ClassifyServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Classify': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=classify__pb2.ClassifyResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'classify.Classify', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('classify.Classify', rpc_method_handlers)
...
class Classify(object):
    ...
    def Classify(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            classify__pb2.ClassifyResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
